...
import (
	...
	cdiv1alpha1ac "k8s.io/client-go/applyconfigurations/cdi/v1alpha1"
...
func setup(t *testing.T, nodes []*v1.Node, claims []*cdiv1alpha1.ResourceClaim) (result *testContext) {
	tc := &testContext{}
	...
	for _, claim := range claims {
		tc.client.CdiV1alpha1().ResourceClaims(claim.Namespace).Create(tc.ctx, claim, metav1.CreateOptions{})
	}
