...
import (
	...
	"k8s.io/kubernetes/pkg/registry/cdi/resourceclaim"
...
func NewREST(optsGetter generic.RESTOptionsGetter) (*REST, *StatusREST, error) {
	store := &genericregistry.Store{
		NewFunc:                  func() runtime.Object { return &cdi.ResourceClaim{} },
		NewListFunc:              func() runtime.Object { return &cdi.ResourceClaimList{} },
		PredicateFunc:            resourceclaim.Match,
		DefaultQualifiedResource: cdi.Resource("resourceclaims"),
...
func (r *REST) defaultOnRead(obj runtime.Object) {
	switch s := obj.(type) {
	case *cdi.ResourceClaim:
		r.defaultOnReadClaim(s)
	case *cdi.ResourceClaimList:
...
func (r *REST) defaultOnReadClaimList(list *cdi.ResourceClaimList) {
	if list == nil {
		return
	}
...
func (r *REST) defaultOnReadClaim(claim *cdi.ResourceClaim) {
	if claim == nil {
		return
	}
