...
func (resourceClassStrategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	resourceClass := obj.(*cdi.ResourceClass)
...
func (resourceClassStrategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	errorList := validation.ValidateResourceClass(obj.(*cdi.ResourceClass))
	return append(errorList, validation.ValidateResourceClassUpdate(obj.(*cdi.ResourceClass), old.(*cdi.ResourceClass))...)
}
