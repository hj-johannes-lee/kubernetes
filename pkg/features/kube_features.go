...
var defaultKubernetesFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	...
	CSIVolumeFSGroupPolicy: {Default: true, PreRelease: featuregate.GA, LockToDefault: true}, // remove in 1.25 together with code
	...
	PodDisruptionBudget: {Default: true, PreRelease: featuregate.GA, LockToDefault: true}, // remove in 1.25 together with code
