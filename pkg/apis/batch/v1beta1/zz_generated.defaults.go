...
func SetObjectDefaults_CronJob(in *v1beta1.CronJob) {
	...
	for i := range in.Spec.JobTemplate.Spec.Template.Spec.ResourceClaims {
		...
		if a.Template != nil {
			v1.SetDefaults_ResourceClaimSpec(&a.Template.Spec)
		}
	}
}
...
func SetObjectDefaults_JobTemplate(in *v1beta1.JobTemplate) {
	...
	for i := range in.Template.Spec.Template.Spec.ResourceClaims {
		a := &in.Template.Spec.Template.Spec.ResourceClaims[i]
		if a.Template != nil {
			v1.SetDefaults_ResourceClaimSpec(&a.Template.Spec)
		}
	}
