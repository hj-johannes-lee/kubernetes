...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*core.ResourceClaimSpec)(nil), (*v1.ResourceClaimSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*v1.ResourceClaimSpec)(nil), (*core.ResourceClaimSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1_PodResourceClaim_To_core_PodResourceClaim(in *v1.PodResourceClaim, out *core.PodResourceClaim, s conversion.Scope) error {
	...
	if in.Template != nil {
		...
		*out = new(core.ResourceClaimTemplate)
		if err := Convert_v1_ResourceClaimTemplate_To_core_ResourceClaimTemplate(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Template = nil
...
func autoConvert_core_PodResourceClaim_To_v1_PodResourceClaim(in *core.PodResourceClaim, out *v1.PodResourceClaim, s conversion.Scope) error {
	...
	if in.Template != nil {
		in, out := &in.Template, &out.Template
		*out = new(v1.ResourceClaimTemplate)
		if err := Convert_core_ResourceClaimTemplate_To_v1_ResourceClaimTemplate(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Template = nil
...
func autoConvert_v1_PodSpec_To_core_PodSpec(in *v1.PodSpec, out *core.PodSpec, s conversion.Scope) error {
	...
	if in.ResourceClaims != nil {
		...
		*out = make([]core.PodResourceClaim, len(*in))
		for i := range *in {
			if err := Convert_v1_PodResourceClaim_To_core_PodResourceClaim(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_core_PodSpec_To_v1_PodSpec(in *core.PodSpec, out *v1.PodSpec, s conversion.Scope) error {
	...
	if in.ResourceClaims != nil {
		...
		*out = make([]v1.PodResourceClaim, len(*in))
		for i := range *in {
			if err := Convert_core_PodResourceClaim_To_v1_PodResourceClaim(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
