...
// Convert_core_ResourceClaimSpec_To_v1_ResourceClaimSpec is defined outside the autogenerated file for use by other API packages
...
// Convert_v1_ResourceClaimSpec_To_core_ResourceClaimSpec is defined outside the autogenerated file for use by other API packages
