...
import (
	...
	v1alpha1 "k8s.io/client-go/listers/cdi/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CdiV1alpha1().ResourceClaims(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CdiV1alpha1().ResourceClaims(namespace).Watch(context.TODO(), options)
			},
		},
		&cdiv1alpha1.ResourceClaim{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resourceClaimInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cdiv1alpha1.ResourceClaim{}, f.defaultInformer)
}
