	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CdiV1alpha1().ResourceClasses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CdiV1alpha1().ResourceClasses().Watch(context.TODO(), options)
			},
		},
		&cdiv1alpha1.ResourceClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resourceClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cdiv1alpha1.ResourceClass{}, f.defaultInformer)
}
