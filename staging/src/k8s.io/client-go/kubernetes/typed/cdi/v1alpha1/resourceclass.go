...
type ResourceClassInterface interface {
	...
	Apply(ctx context.Context, resourceClass *cdiv1alpha1.ResourceClassApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClass, err error)
...
func newResourceClasses(c *CdiV1alpha1Client) *resourceClasses {
...
func (c *resourceClasses) Apply(ctx context.Context, resourceClass *cdiv1alpha1.ResourceClassApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClass, err error) {
