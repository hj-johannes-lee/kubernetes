...
// CdiV1alpha1Client is used to interact with features provided by the cdi.k8s.io group.
type CdiV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CdiV1alpha1Client) ResourceClaims(namespace string) ResourceClaimInterface {
	return newResourceClaims(c, namespace)
}

func (c *CdiV1alpha1Client) ResourceClasses() ResourceClassInterface {
