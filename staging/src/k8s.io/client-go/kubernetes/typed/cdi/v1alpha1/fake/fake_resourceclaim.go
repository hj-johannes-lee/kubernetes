...
var resourceclaimsResource = schema.GroupVersionResource{Group: "cdi.k8s.io", Version: "v1alpha1", Resource: "resourceclaims"}

var resourceclaimsKind = schema.GroupVersionKind{Group: "cdi.k8s.io", Version: "v1alpha1", Kind: "ResourceClaim"}
...
func (c *FakeResourceClaims) Apply(ctx context.Context, resourceClaim *cdiv1alpha1.ResourceClaimApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClaim, err error) {
...
func (c *FakeResourceClaims) ApplyStatus(ctx context.Context, resourceClaim *cdiv1alpha1.ResourceClaimApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClaim, err error) {
	if resourceClaim == nil {
		return nil, fmt.Errorf("resourceClaim provided to Apply must not be nil")
	}
	data, err := json.Marshal(resourceClaim)
