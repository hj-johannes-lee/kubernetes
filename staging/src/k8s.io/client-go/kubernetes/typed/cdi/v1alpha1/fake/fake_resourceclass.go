...
var resourceclassesResource = schema.GroupVersionResource{Group: "cdi.k8s.io", Version: "v1alpha1", Resource: "resourceclasses"}

var resourceclassesKind = schema.GroupVersionKind{Group: "cdi.k8s.io", Version: "v1alpha1", Kind: "ResourceClass"}
...
func (c *FakeResourceClasses) Apply(ctx context.Context, resourceClass *cdiv1alpha1.ResourceClassApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClass, err error) {
