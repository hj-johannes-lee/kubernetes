...
type ResourceClaimInterface interface {
	...
	Apply(ctx context.Context, resourceClaim *cdiv1alpha1.ResourceClaimApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClaim, err error)
	ApplyStatus(ctx context.Context, resourceClaim *cdiv1alpha1.ResourceClaimApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClaim, err error)
...
func newResourceClaims(c *CdiV1alpha1Client, namespace string) *resourceClaims {
...
func (c *resourceClaims) Apply(ctx context.Context, resourceClaim *cdiv1alpha1.ResourceClaimApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClaim, err error) {
...
func (c *resourceClaims) ApplyStatus(ctx context.Context, resourceClaim *cdiv1alpha1.ResourceClaimApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClaim, err error) {
	if resourceClaim == nil {
		return nil, fmt.Errorf("resourceClaim provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
