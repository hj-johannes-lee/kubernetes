...
type ResourceClaimSpecApplyConfiguration struct {
	...
	AllocationMode    *v1.AllocationMode    `json:"allocationMode,omitempty"`
}
...
func (b *ResourceClaimSpecApplyConfiguration) WithParameters(value runtime.RawExtension) *ResourceClaimSpecApplyConfiguration {
	b.Parameters = &value
	return b
}
...
func (b *ResourceClaimSpecApplyConfiguration) WithAllocationMode(value v1.AllocationMode) *ResourceClaimSpecApplyConfiguration {
