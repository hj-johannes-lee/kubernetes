...
type PodResourceClaimApplyConfiguration struct {
	...
	Template          *ResourceClaimTemplateApplyConfiguration `json:"template,omitempty"`
}
...
func (b *PodResourceClaimApplyConfiguration) WithTemplate(value *ResourceClaimTemplateApplyConfiguration) *PodResourceClaimApplyConfiguration {
	b.Template = value
	return b
}
