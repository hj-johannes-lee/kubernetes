...
type ResourceClaimApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *corev1.ResourceClaimSpecApplyConfiguration `json:"spec,omitempty"`
...
func ResourceClaim(name, namespace string) *ResourceClaimApplyConfiguration {
	...
	b.WithAPIVersion("cdi.k8s.io/v1alpha1")
	return b
}
...
// Experimental!
func ExtractResourceClaim(resourceClaim *cdiv1alpha1.ResourceClaim, fieldManager string) (*ResourceClaimApplyConfiguration, error) {
...
// Experimental!
func ExtractResourceClaimStatus(resourceClaim *cdiv1alpha1.ResourceClaim, fieldManager string) (*ResourceClaimApplyConfiguration, error) {
	return extractResourceClaim(resourceClaim, fieldManager, "status")
}

func extractResourceClaim(resourceClaim *cdiv1alpha1.ResourceClaim, fieldManager string, subresource string) (*ResourceClaimApplyConfiguration, error) {
	b := &ResourceClaimApplyConfiguration{}
	err := managedfields.ExtractInto(resourceClaim, internal.Parser().Type("io.k8s.api.cdi.v1alpha1.ResourceClaim"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *ResourceClaimApplyConfiguration) WithSpec(value *corev1.ResourceClaimSpecApplyConfiguration) *ResourceClaimApplyConfiguration {
	b.Spec = value
	return b
}
