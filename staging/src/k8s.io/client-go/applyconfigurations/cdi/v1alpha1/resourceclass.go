...
// Experimental!
func ExtractResourceClass(resourceClass *v1alpha1.ResourceClass, fieldManager string) (*ResourceClassApplyConfiguration, error) {
...
// Experimental!
func ExtractResourceClassStatus(resourceClass *v1alpha1.ResourceClass, fieldManager string) (*ResourceClassApplyConfiguration, error) {
	return extractResourceClass(resourceClass, fieldManager, "status")
}

func extractResourceClass(resourceClass *v1alpha1.ResourceClass, fieldManager string, subresource string) (*ResourceClassApplyConfiguration, error) {
	b := &ResourceClassApplyConfiguration{}
	err := managedfields.ExtractInto(resourceClass, internal.Parser().Type("io.k8s.api.cdi.v1alpha1.ResourceClass"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *ResourceClassApplyConfiguration) WithParameters(value runtime.RawExtension) *ResourceClassApplyConfiguration {
	b.Parameters = &value
	return b
}
